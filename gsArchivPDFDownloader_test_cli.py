...
def test_range_1_invalid1(testrange='1996:01-2013:13'):
    ...
    """
    exit_status = os.system(f'python -m gsArchivPDFDownloader  -r {testrange}')
...
def test_full():
    ...
    full run test
    """
    exit_status = os.system(f'python -m gsArchivPDFDownloader  -f')
    assert exit_status == 0
...
def test_year_1():
    ...
    year 2020
    """
    exit_status = os.system(f'python -m gsArchivPDFDownloader  -y 2020')
    assert exit_status == 0
...
def test_year_2():
    ...
    year 2021
    """
    exit_status = os.system(f'python -m gsArchivPDFDownloader  -y 2021')
    assert exit_status == 0
